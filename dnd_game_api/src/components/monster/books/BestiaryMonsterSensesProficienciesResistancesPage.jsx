      ...
      try {
        ...
        return (
          <>
            ...
            {monster.senses && (
              <div className="mb-2">
                <span className="text-sm"><strong>Senses:</strong> {formatSenses(monster.senses)}</span>
              </div>
            )}
            ...
            {(monster.damage_vulnerabilities?.length > 0) && (
              <div className="mb-2">
                <span className="text-sm"><strong>Vulnerabilities:</strong> {monster.damage_vulnerabilities.join(",")}</span>
              </div>
            )}
            {(monster.damage_resistances?.length > 0) && (
              <div className="mb-2">
                <span className="text-sm"><strong>Resistances:</strong> {monster.damage_resistances.join(",")}</span>
              </div>
            )}
            {(monster.damage_immunities?.length > 0) && (
              <div className="mb-2">
                <span className="text-sm"><strong>Immunities:</strong> {monster.damage_immunities.join(",")}</span>
              </div>
            )}
